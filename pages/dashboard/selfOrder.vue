<template>
  <div>
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
      <h4 class="tx-gray-800 mg-b-5">Self Order</h4>
    ...
    <div class="br-pagebody">
        ...
        <div class="card mb-2">
          ...
          <div class="card-body">
            ...
            <div class="row d-flex justify-content-between">
              <div class="col-3">
                <div class="form-group">
                  <button class="btn btn-outline-primary btn-block" @click="exportExcel">Export Excel</button>
                </div>
              </div>
              <div class="col-3">
                <div class="form-group">
                  <button class="btn btn-primary btn-block" @click="addSelfOrder">Tambah order</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <b-modal id="tambahOrder" size="lg" title="Tambah Order">
        <p>Tambah Order</p>
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { idx: 3, key: "no_telp", label: "No Telp", sortable: true },
  ...
  methods: {
    ...
    addSelfOrder: function() {
      console.log("add self order");
      this.$router.push("tambahSelfOrder");
    }
  }
};
</script>
